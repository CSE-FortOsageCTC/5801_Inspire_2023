...
public class AutoBalance extends CommandBase {
    ...
    public void execute(){        
        ...
        SmartDashboard.putNumber("Gyro Pitch", gyro.getPitch());//displaying pitch value in degrees on dashboard
        ...
        try {
            translation = new Translation2d(yAxisRate, 0).times(Constants.Swerve.maxSpeed/1.5);
