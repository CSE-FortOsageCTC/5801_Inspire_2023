...
public class A3B4C extends SequentialCommandGroup {
  ...
  public A3B4C(Swerve drive, ArmSubsystem s_ArmSubsystem, IntakeSubsystem s_IntakeSubsystem) {
    ...
    PathPlannerTrajectory A3C = PathPlanner.loadPath("A3C", 1.0, 1.0);
    ...
    addCommands(
      ...
      drive.followTrajectoryCommand(A3C, true).alongWith(new PositionArm(s_ArmSubsystem, ArmPosition.Floor)),//move to and prepare arm for field cone
