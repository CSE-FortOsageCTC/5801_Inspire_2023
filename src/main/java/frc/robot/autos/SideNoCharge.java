...
public class SideNoCharge extends SequentialCommandGroup {
  
  public SideNoCharge(Swerve drive, ArmSubsystem s_ArmSubsystem, IntakeSubsystem s_IntakeSubsystem) {
